...
@Component({
  ...
  standalone: true,
  imports: [TabsModule,CheckboxModule,FormsModule,ReactiveFormsModule,CommonModule,PibFormsModule,ButtonModule,
    CronPerSecondsComponent,CronForDaysComponent,CronForHoursComponent,CronForMinutesComponent,CronForMonthsComponent,CronForYearComponent],
